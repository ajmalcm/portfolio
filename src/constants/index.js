export const myProjects = [
  ...
  },
  {
    ...
    tags: [
      { id: 1, name: "MERN", path: "/assets/logos/react.svg" },
      { id: 2, name: "MUI", path: "/assets/logos/mui.svg" },
      { id: 3, name: "Socket.io", path: "/assets/logos/socket.svg" },
      { id: 4, name: "Chart.js", path: "/assets/logos/chart.svg" },
    ],
  },
  {
    id: 3,
    ...
    logo: "",
    image: "/assets/projects/gameInspo.png",
    tags: [
      { id: 1, name: "Next.js", path: "/assets/logos/next.svg" },
      { id: 2, name: "TailwindCSS", path: "/assets/logos/tailwindcss.svg" },
    ],
  },
  {
    ...
    logo: "",
    image: "/assets/projects/eggMaster.png",
    tags: [
      { id: 1, name: "Next.js", path: "/assets/logos/next.svg" },
      { id: 2, name: "TailwindCSS", path: "/assets/logos/tailwindcss.svg" },
    ],
  ...
  },
  {
    ...
    logo: "",
    image: "/assets/projects/pictoSaas.png",
    tags: [
      { id: 1, name: "Next.js", path: "/assets/logos/next.svg" },
      { id: 2, name: "Clerk", path: "/assets/logos/auth.svg" },
