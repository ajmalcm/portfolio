...
const ProjectDetails = ({title,description,subDescription,image,tags,href,closeModal}) => {
  return (
    ...
    <button className="absolute p-2 rounded-sm top-5 right-5 bg-midnight hover:bg-gray-500" onClick={closeModal}>
    ...
    <div className="p-5">
        ...
        <div className="flex items-center justify-between mt-4">
            ...
            <a className="inline-flex items-center gap-1 font-medium cursor-pointer hover-animation" href={href} target="_blank">View Project <img src="assets/arrow-up.svg" className="size-4"/></a>
        </div>
    </div>
    </motion.div>
    </div>
